...
const ParentDashboardLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const isDetailPage = location.pathname.includes('/child/');
  const handleBack = () => navigate('/parent/dashboard');
